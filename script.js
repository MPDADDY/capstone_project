...
const featuredSpeakers = [
  {
    name: 'Yochai Benkler',
    image: '<img src="images/speaker_01 1 (5).png" alt="Yochai Benlers image">',
    profession: 'Berkman: proffessor of enterpreneurial Legal Studies at Harvard Law School',
    description: 'Benkler studies commons-based peer production, and published his seminal book, The Wealth of Networks in 2006',
  },
  {
    name: 'Kilnam Chon',
    image: '<img src="images/speaker_01 1.png" alt="Kilnam Chon image">',
    profession: '',
  ...
  {
    name: 'Lila Tretikov',
    image: '<img src="images/speaker_01 1 (3).png" alt="Lila image">',
  ...
  {
    name: 'Julia Leda',
    image: ' <img src="images/speaker_01 1 (1).png" alt=" Julia image">',
  ...
  {
    name: 'SohYeong Noh',
    image: '<img src="images/speaker_01 1 (4).png" alt="SohYeong image">',
    profession: 'Director of Art Centre Nabi and a board member of CC Korea',
    description: 'As the main venue for new media art production in Korea, Nabi promotes cross-disciplinary collaboration and understanding among science technology, humanities, and the arts.',
  },
  {
    name: 'Ryan Merkley',
    image: '<img src="images/speaker_01 1 (2).png" alt="Ryan image">',
